...
client.on("message", msg =>{
    ...
    else if(msgContent[0] == "!end"){
        client.commands.get("end").execute(msg, CurrentGames);
    }
    else if(msgContent[0] == "!help"){
        client.commands.get("help").execute(msg);
    }
    else if(msgContent[0] == "!config"){
        client.commands.get("config").execute(msg);
    }
    //make sure these commands can only be accessed by admins
